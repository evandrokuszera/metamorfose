 ...
 * @author Evandro
 */
public class JavascriptTransformationEngine implements Serializable {
    ...
    public Object executeTransformation(String methodName, Object[] value) {              
        ...
        if (factory == null) {
            ...
            try {
                ...
                System.out.println("ERRO: " + JavascriptTransformationEngine.class.getName() + ":" + ex);
    ...
    public static void main(String[] args) {
        ...
        JavascriptTransformationEngine engine = new JavascriptTransformationEngine();
        
        engine.setScripts(scripts);
                
        String methodName = "desconto";

        Object[] parameters = new Object[1];
        parameters[0] = 10;

        System.out.println(engine.executeTransformation(methodName, parameters));
